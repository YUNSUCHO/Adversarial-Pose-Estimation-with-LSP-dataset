...
parser.add_argument('--path', \
    default='/home/ycho/Adversarial-Pose-EstimationV.4/lsp_dataset/lsp_dataset')
...
class LSP(Dataset):
    ...
    def __init__(self, cfg):
        ...
        self.path = cfg.path
        self.path_s= '/home/ycho/Adversarial-Pose-EstimationV.4/lspet_dataset'
        self.mode = cfg.mode
